---
id: church.worship.select_ambient_vs_dynamic_loop
tier: production
vertical: church
title: "Select Ambient Vs Dynamic Loop"
...
# Select Ambient Vs Dynamic Loop

## Purpose

Worship environment visual: select ambient vs dynamic loop.
