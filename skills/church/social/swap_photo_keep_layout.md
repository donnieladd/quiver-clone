---
id: church.social.swap_photo_keep_layout
tier: production
vertical: church
title: "Swap photo while keeping layout locked"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Swap photo while keeping layout locked

## Purpose

Swap photo while keeping layout locked for church social workflow efficiency.
