---
id: church.social.template_series_week_promo
tier: template
vertical: church
title: "Series week N promo template"
inputs: [template_duplicate, copy, series_brand]
outputs: [1080x1350png]
related: [church.ops.duplicate_template_not_redesign, church.qa.text_legibility_mobile]
---

# Series week N promo template

## Purpose

Produce series week n promo template using locked layout and series/church brand kit.
