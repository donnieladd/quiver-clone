---
id: church.social.write_caption_from_template
tier: production
vertical: church
title: "Write caption from template formula"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Write caption from template formula

## Purpose

Write caption from template formula for church social workflow efficiency.
