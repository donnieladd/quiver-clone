---
id: church.social.duplicate_template_not_redesign
tier: production
vertical: church
title: "Duplicate social template without redesign"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Duplicate social template without redesign

## Purpose

Duplicate social template without redesign for church social workflow efficiency.
