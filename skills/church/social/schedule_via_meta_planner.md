---
id: church.social.schedule_via_meta_planner
tier: production
vertical: church
title: "Schedule via Meta content planner"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Schedule via Meta content planner

## Purpose

Schedule via Meta content planner for church social workflow efficiency.
