---
id: church.social.template_series_launch
tier: template
vertical: church
title: "Series launch announcement template"
inputs: [template_duplicate, copy, series_brand]
outputs: [1080x1080png]
related: [church.ops.duplicate_template_not_redesign, church.qa.text_legibility_mobile]
---

# Series launch announcement template

## Purpose

Produce series launch announcement template using locked layout and series/church brand kit.
