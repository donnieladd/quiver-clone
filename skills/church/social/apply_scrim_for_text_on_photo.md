---
id: church.social.apply_scrim_for_text_on_photo
tier: production
vertical: church
title: "Apply scrim for text on photo"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Apply scrim for text on photo

## Purpose

Apply scrim for text on photo for church social workflow efficiency.
