---
id: church.social.crosspost_adapt_not_identical
tier: production
vertical: church
title: "Cross-post with platform adaptation"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Cross-post with platform adaptation

## Purpose

Cross-post with platform adaptation for church social workflow efficiency.
