---
id: church.social.add_hashtags_local_and_church
tier: production
vertical: church
title: "Add local and church hashtags"
inputs: [approved_templates]
outputs: [scheduled_posts]
related: [church.workflow.sermon_to_social]
---

# Add local and church hashtags

## Purpose

Add local and church hashtags for church social workflow efficiency.
