---
id: church.content.avoid_out_of_context_quotes
tier: production
vertical: church
title: "Avoid Out Of Context Quotes"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Avoid Out Of Context Quotes

## Purpose

Sermon content multiplication: avoid out of context quotes.
