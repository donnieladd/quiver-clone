---
id: church.content.plan_easter_content_calendar
tier: production
vertical: church
title: "Plan Easter Content Calendar"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Plan Easter Content Calendar

## Purpose

Sermon content multiplication: plan easter content calendar.
