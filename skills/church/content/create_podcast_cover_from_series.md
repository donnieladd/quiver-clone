---
id: church.content.create_podcast_cover_from_series
tier: production
vertical: church
title: "Create Podcast Cover From Series"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Create Podcast Cover From Series

## Purpose

Sermon content multiplication: create podcast cover from series.
