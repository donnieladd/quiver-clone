---
id: church.content.tag_sermon_topic_taxonomy
tier: production
vertical: church
title: "Tag Sermon Topic Taxonomy"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Tag Sermon Topic Taxonomy

## Purpose

Sermon content multiplication: tag sermon topic taxonomy.
