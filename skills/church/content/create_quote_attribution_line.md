---
id: church.content.create_quote_attribution_line
tier: production
vertical: church
title: "Create Quote Attribution Line"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Create Quote Attribution Line

## Purpose

Sermon content multiplication: create quote attribution line.
