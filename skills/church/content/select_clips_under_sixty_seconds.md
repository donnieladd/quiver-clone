---
id: church.content.select_clips_under_sixty_seconds
tier: production
vertical: church
title: "Select Clips Under Sixty Seconds"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Select Clips Under Sixty Seconds

## Purpose

Sermon content multiplication: select clips under sixty seconds.
