---
id: church.content.select_clips_under_ninety_seconds
tier: production
vertical: church
title: "Select Clips Under Ninety Seconds"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Select Clips Under Ninety Seconds

## Purpose

Sermon content multiplication: select clips under ninety seconds.
