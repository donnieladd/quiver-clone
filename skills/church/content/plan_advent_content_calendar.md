---
id: church.content.plan_advent_content_calendar
tier: production
vertical: church
title: "Plan Advent Content Calendar"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Plan Advent Content Calendar

## Purpose

Sermon content multiplication: plan advent content calendar.
