---
id: church.content.repurpose_archive_sermon
tier: production
vertical: church
title: "Repurpose Archive Sermon"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Repurpose Archive Sermon

## Purpose

Sermon content multiplication: repurpose archive sermon.
