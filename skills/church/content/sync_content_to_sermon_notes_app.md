---
id: church.content.sync_content_to_sermon_notes_app
tier: production
vertical: church
title: "Sync Content To Sermon Notes App"
inputs: [transcript_or_video, series_metadata]
outputs: [content_package]
related: [church.workflow.sermon_to_social]
---

# Sync Content To Sermon Notes App

## Purpose

Sermon content multiplication: sync content to sermon notes app.
