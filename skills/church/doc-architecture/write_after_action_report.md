---
id: church.doc-architecture.write_after_action_report
tier: reporting
vertical: church
title: "Write after action report"
inputs: []
outputs: [document_artifact]
related: [church.workflow.post_event_aar]
...
Post-event: what worked, didn't, improvements.
...
### Header
- Document type: Write after action report
- Owner:
- Date:
- Version:
