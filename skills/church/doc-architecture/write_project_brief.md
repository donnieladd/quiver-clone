---
id: church.doc-architecture.write_project_brief
tier: alignment
vertical: church
title: "Write project brief"
inputs: []
outputs: [document_artifact]
related: [church.doc-architecture.write_creative_brief]
...
Scope, goals, timeline, stakeholders for cross-functional initiatives.
...
### Header
- Document type: Write project brief
- Owner:
- Date:
- Version:
