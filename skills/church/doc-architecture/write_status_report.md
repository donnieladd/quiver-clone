---
id: church.doc-architecture.write_status_report
tier: reporting
vertical: church
title: "Write status report"
inputs: []
outputs: [document_artifact]
related: [church.doc-architecture.INDEX]
...
Weekly progress, risks, next steps for leadership.
...
### Header
- Document type: Write status report
- Owner:
- Date:
- Version:
