---
id: church.doc-architecture.write_run_of_show
tier: planning
vertical: church
title: "Write run of show"
inputs: []
outputs: [document_artifact]
related: [church.workflow.worship_visuals]
...
Time-stamped live event execution sequence.
...
### Header
- Document type: Write run of show
- Owner:
- Date:
- Version:
