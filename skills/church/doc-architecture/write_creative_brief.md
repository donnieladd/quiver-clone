---
id: church.doc-architecture.write_creative_brief
tier: alignment
vertical: church
title: "Write creative brief"
inputs: []
outputs: [document_artifact]
related: [church.ops.intake_creative_brief_form]
...
Align creative teams before production. Audience, objective, tone, deliverables, constraints. Not an approval doc.
...
### Header
- Document type: Write creative brief
- Owner:
- Date:
- Version:
