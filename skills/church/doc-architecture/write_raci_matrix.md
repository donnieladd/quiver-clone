---
id: church.doc-architecture.write_raci_matrix
tier: governance
vertical: church
title: "Write RACI matrix"
inputs: []
outputs: [document_artifact]
related: [church.doc-architecture.write_project_charter]
...
Responsible, Accountable, Consulted, Informed for cross-functional work.
...
### Header
- Document type: Write RACI matrix
- Owner:
- Date:
- Version:
