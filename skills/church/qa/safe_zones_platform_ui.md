---
id: church.qa.safe_zones_platform_ui
tier: qa
vertical: church
title: "Verify platform UI safe zones"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Verify platform UI safe zones

## Purpose

Quality assurance: Verify platform UI safe zones.
