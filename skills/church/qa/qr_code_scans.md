---
id: church.qa.qr_code_scans
tier: qa
vertical: church
title: "Test QR code scans on final graphic"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Test QR code scans on final graphic

## Purpose

Quality assurance: Test QR code scans on final graphic.
