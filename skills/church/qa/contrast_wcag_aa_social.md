---
id: church.qa.contrast_wcag_aa_social
tier: qa
vertical: church
title: "Check WCAG AA contrast on social"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Check WCAG AA contrast on social

## Purpose

Quality assurance: Check WCAG AA contrast on social.
