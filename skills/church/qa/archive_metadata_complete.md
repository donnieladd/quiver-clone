---
id: church.qa.archive_metadata_complete
tier: qa
vertical: church
title: "Verify archive metadata complete"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Verify archive metadata complete

## Purpose

Quality assurance: Verify archive metadata complete.
