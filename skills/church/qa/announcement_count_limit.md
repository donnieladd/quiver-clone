---
id: church.qa.announcement_count_limit
tier: qa
vertical: church
title: "Enforce announcement count limit"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Enforce announcement count limit

## Purpose

Quality assurance: Enforce announcement count limit.
