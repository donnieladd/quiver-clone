---
id: church.qa.motion_not_distracting_behind_speaker
tier: qa
vertical: church
title: "Check motion not distracting behind speaker"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Check motion not distracting behind speaker

## Purpose

Quality assurance: Check motion not distracting behind speaker.
