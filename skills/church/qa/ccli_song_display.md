---
id: church.qa.ccli_song_display
tier: qa
vertical: church
title: "Verify CCLI song display compliance"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Verify CCLI song display compliance

## Purpose

Quality assurance: Verify CCLI song display compliance.
