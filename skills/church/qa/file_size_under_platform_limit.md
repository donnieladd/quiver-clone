---
id: church.qa.file_size_under_platform_limit
tier: qa
vertical: church
title: "Verify file size under platform limit"
inputs: [candidate_asset]
outputs: [pass_fail_report]
related: [church.workflow.approval_governance]
---

# Verify file size under platform limit

## Purpose

Quality assurance: Verify file size under platform limit.
