---
id: church.brand.define_subbrand_ministries
tier: foundation
vertical: church
...
# Define sub-brand rules for ministries

## Purpose

Kids, youth, worship album releases may have accent colors but share master logo.
...
- `church.env.design_child_ministry_visual_system`
