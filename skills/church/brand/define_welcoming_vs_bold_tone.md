---
id: church.brand.define_welcoming_vs_bold_tone
tier: foundation
vertical: church
...
# Define welcoming vs bold tone for outreach

## Purpose

Calibrate visual boldness for invite cards vs internal comms.
...
- `church.brand.define_voice_attributes`
