---
id: church.series.create_countdown_to_series
tier: production
vertical: church
title: "Create countdown graphics to series start"
...
# Create countdown graphics to series start

## Purpose

Create countdown graphics to series start for multi-week sermon series branding.
