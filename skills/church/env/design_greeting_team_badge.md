---
id: church.env.design_greeting_team_badge
tier: production
vertical: church
title: "Design Greeting Team Badge"
inputs: [dimensions, series_or_brand]
outputs: [print_or_digital_env_asset]
related: [church.series.design_key_art]
---

# Design Greeting Team Badge

## Purpose

Environmental church graphics: design greeting team badge.
