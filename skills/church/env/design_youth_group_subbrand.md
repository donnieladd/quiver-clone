---
id: church.env.design_youth_group_subbrand
tier: production
vertical: church
title: "Design Youth Group Subbrand"
inputs: [dimensions, series_or_brand]
outputs: [print_or_digital_env_asset]
related: [church.series.design_key_art]
---

# Design Youth Group Subbrand

## Purpose

Environmental church graphics: design youth group subbrand.
