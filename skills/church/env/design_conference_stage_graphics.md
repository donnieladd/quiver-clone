---
id: church.env.design_conference_stage_graphics
tier: production
vertical: church
title: "Design Conference Stage Graphics"
inputs: [dimensions, series_or_brand]
outputs: [print_or_digital_env_asset]
related: [church.series.design_key_art]
---

# Design Conference Stage Graphics

## Purpose

Environmental church graphics: design conference stage graphics.
