---
id: church.env.design_child_ministry_visual_system
tier: production
vertical: church
title: "Design Child Ministry Visual System"
inputs: [dimensions, series_or_brand]
outputs: [print_or_digital_env_asset]
related: [church.series.design_key_art]
---

# Design Child Ministry Visual System

## Purpose

Environmental church graphics: design child ministry visual system.
