---
id: church.env.design_gazebo_tent_graphic
tier: production
vertical: church
title: "Design Gazebo Tent Graphic"
inputs: [dimensions, series_or_brand]
outputs: [print_or_digital_env_asset]
related: [church.series.design_key_art]
---

# Design Gazebo Tent Graphic

## Purpose

Environmental church graphics: design gazebo tent graphic.
