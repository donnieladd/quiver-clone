---
id: church.motion.build_mogrt_template
tier: production
vertical: church
title: "Build After Effects MOGRT template"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Build After Effects MOGRT template

## Purpose

Build After Effects MOGRT template for church motion pipeline.
