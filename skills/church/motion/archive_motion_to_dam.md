---
id: church.motion.archive_motion_to_dam
tier: production
vertical: church
title: "Archive motion files to DAM"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Archive motion files to DAM

## Purpose

Archive motion files to DAM for church motion pipeline.
