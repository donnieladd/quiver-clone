---
id: church.motion.optimize_bitrate_for_venue_wifi
tier: production
vertical: church
title: "Optimize bitrate for venue streaming"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Optimize bitrate for venue streaming

## Purpose

Optimize bitrate for venue streaming for church motion pipeline.
