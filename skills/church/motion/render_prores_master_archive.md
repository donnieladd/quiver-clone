---
id: church.motion.render_prores_master_archive
tier: production
vertical: church
title: "Render ProRes master for archive"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Render ProRes master for archive

## Purpose

Render ProRes master for archive for church motion pipeline.
