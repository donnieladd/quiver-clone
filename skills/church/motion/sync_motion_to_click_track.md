---
id: church.motion.sync_motion_to_click_track
tier: production
vertical: church
title: "Sync motion to worship click track"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Sync motion to worship click track

## Purpose

Sync motion to worship click track for church motion pipeline.
