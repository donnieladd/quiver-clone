---
id: church.motion.test_export_on_propresenter
tier: production
vertical: church
title: "Test motion export in ProPresenter"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Test motion export in ProPresenter

## Purpose

Test motion export in ProPresenter for church motion pipeline.
