---
id: church.motion.document_motion_codec_standards
tier: production
vertical: church
title: "Document motion codec standards for church"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Document motion codec standards for church

## Purpose

Document motion codec standards for church for church motion pipeline.
