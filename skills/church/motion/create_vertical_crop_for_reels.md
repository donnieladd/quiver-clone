---
id: church.motion.create_vertical_crop_for_reels
tier: production
vertical: church
title: "Create vertical crop for reels from 16:9"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Create vertical crop for reels from 16:9

## Purpose

Create vertical crop for reels from 16:9 for church motion pipeline.
