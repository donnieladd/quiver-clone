---
id: church.motion.design_stinger_transition
tier: production
vertical: church
title: "Design stinger transition bumper"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Design stinger transition bumper

## Purpose

Design stinger transition bumper for church motion pipeline.
