---
id: church.motion.design_offering_motion
tier: production
vertical: church
title: "Design offering motion background"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Design offering motion background

## Purpose

Design offering motion background for church motion pipeline.
