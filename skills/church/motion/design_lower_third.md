---
id: church.motion.design_lower_third
tier: production
vertical: church
title: "Design lower third name strap"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Design lower third name strap

## Purpose

Design lower third name strap for church motion pipeline.
