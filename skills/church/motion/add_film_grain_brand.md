---
id: church.motion.add_film_grain_brand
tier: production
vertical: church
title: "Add brand-approved film grain"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Add brand-approved film grain

## Purpose

Add brand-approved film grain for church motion pipeline.
