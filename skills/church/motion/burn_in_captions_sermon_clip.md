---
id: church.motion.burn_in_captions_sermon_clip
tier: production
vertical: church
title: "Burn in captions on sermon clip"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Burn in captions on sermon clip

## Purpose

Burn in captions on sermon clip for church motion pipeline.
