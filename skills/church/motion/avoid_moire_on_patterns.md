---
id: church.motion.avoid_moire_on_patterns
tier: production
vertical: church
title: "Avoid moiré on fine patterns for IMAG"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Avoid moiré on fine patterns for IMAG

## Purpose

Avoid moiré on fine patterns for IMAG for church motion pipeline.
