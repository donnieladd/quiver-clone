---
id: church.motion.export_loop_seamless
tier: production
vertical: church
title: "Export seamless motion loop"
inputs: [series_brand, after_effects_or_canva_video]
outputs: [video_file]
related: [church.worship.select_ambient_vs_dynamic_loop]
---

# Export seamless motion loop

## Purpose

Export seamless motion loop for church motion pipeline.
