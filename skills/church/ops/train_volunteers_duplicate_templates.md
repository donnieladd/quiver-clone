---
id: church.ops.train_volunteers_duplicate_templates
tier: ops
vertical: church
title: "Train Volunteers Duplicate Templates"
inputs: [team_roles]
outputs: [process_artifact]
related: [church.workflow.approval_governance]
---

# Train Volunteers Duplicate Templates

## Purpose

Church media operations: train volunteers duplicate templates.
