---
id: church.ops.duplicate_template_not_redesign
tier: ops
vertical: church
title: "Duplicate Template Not Redesign"
inputs: [team_roles]
outputs: [process_artifact]
related: [church.workflow.approval_governance]
---

# Duplicate Template Not Redesign

## Purpose

Church media operations: duplicate template not redesign.
