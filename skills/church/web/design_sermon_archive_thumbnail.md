---
id: church.web.design_sermon_archive_thumbnail
tier: production
vertical: church
title: "Design Sermon Archive Thumbnail"
inputs: [series_kit, cms_specs]
outputs: [web_asset]
related: [church.workflow.weekly_service_kit]
---

# Design Sermon Archive Thumbnail

## Purpose

Church website media: design sermon archive thumbnail.
