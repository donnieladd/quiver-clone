---
id: church.web.add_open_graph_meta_companion
tier: production
vertical: church
title: "Add Open Graph Meta Companion"
inputs: [series_kit, cms_specs]
outputs: [web_asset]
related: [church.workflow.weekly_service_kit]
---

# Add Open Graph Meta Companion

## Purpose

Church website media: add open graph meta companion.
