---
id: church.web.design_staff_page_headshots_grid
tier: production
vertical: church
title: "Design Staff Page Headshots Grid"
inputs: [series_kit, cms_specs]
outputs: [web_asset]
related: [church.workflow.weekly_service_kit]
---

# Design Staff Page Headshots Grid

## Purpose

Church website media: design staff page headshots grid.
