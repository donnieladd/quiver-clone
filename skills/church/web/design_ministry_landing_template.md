---
id: church.web.design_ministry_landing_template
tier: production
vertical: church
title: "Design Ministry Landing Template"
inputs: [series_kit, cms_specs]
outputs: [web_asset]
related: [church.workflow.weekly_service_kit]
---

# Design Ministry Landing Template

## Purpose

Church website media: design ministry landing template.
