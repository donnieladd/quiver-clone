---
id: church.web.optimize_hero_for_mobile_crop
tier: production
vertical: church
title: "Optimize Hero For Mobile Crop"
inputs: [series_kit, cms_specs]
outputs: [web_asset]
related: [church.workflow.weekly_service_kit]
---

# Optimize Hero For Mobile Crop

## Purpose

Church website media: optimize hero for mobile crop.
