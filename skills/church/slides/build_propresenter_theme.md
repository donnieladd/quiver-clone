---
id: church.slides.build_propresenter_theme
tier: production
vertical: church
title: "Build Propresenter Theme"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Build Propresenter Theme

## Purpose

Church presentation slide skill: build propresenter theme.
