---
id: church.slides.sync_slides_with_speaker_notes
tier: production
vertical: church
title: "Sync Slides With Speaker Notes"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Sync Slides With Speaker Notes

## Purpose

Church presentation slide skill: sync slides with speaker notes.
