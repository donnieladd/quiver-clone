---
id: church.slides.lyric_capitalization_style
tier: production
vertical: church
title: "Lyric Capitalization Style"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Lyric Capitalization Style

## Purpose

Church presentation slide skill: lyric capitalization style.
