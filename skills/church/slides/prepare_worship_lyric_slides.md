---
id: church.slides.prepare_worship_lyric_slides
tier: production
vertical: church
title: "Prepare Worship Lyric Slides"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Prepare Worship Lyric Slides

## Purpose

Church presentation slide skill: prepare worship lyric slides.
