---
id: church.slides.export_powerpoint_backup
tier: production
vertical: church
title: "Export Powerpoint Backup"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Export Powerpoint Backup

## Purpose

Church presentation slide skill: export powerpoint backup.
