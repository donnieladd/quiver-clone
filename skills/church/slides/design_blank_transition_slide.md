---
id: church.slides.design_blank_transition_slide
tier: production
vertical: church
title: "Design Blank Transition Slide"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Design Blank Transition Slide

## Purpose

Church presentation slide skill: design blank transition slide.
