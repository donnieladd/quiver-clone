---
id: church.slides.apply_series_master_to_deck
tier: production
vertical: church
title: "Apply Series Master To Deck"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Apply Series Master To Deck

## Purpose

Church presentation slide skill: apply series master to deck.
