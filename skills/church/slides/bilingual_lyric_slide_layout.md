---
id: church.slides.bilingual_lyric_slide_layout
tier: production
vertical: church
title: "Bilingual Lyric Slide Layout"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Bilingual Lyric Slide Layout

## Purpose

Church presentation slide skill: bilingual lyric slide layout.
