---
id: church.slides.design_illustration_slide
tier: production
vertical: church
title: "Design Illustration Slide"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Design Illustration Slide

## Purpose

Church presentation slide skill: design illustration slide.
