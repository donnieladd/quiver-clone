---
id: church.slides.announcement_seven_second_rule
tier: production
vertical: church
title: "Announcement Seven Second Rule"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Announcement Seven Second Rule

## Purpose

Church presentation slide skill: announcement seven second rule.
