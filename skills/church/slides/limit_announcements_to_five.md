---
id: church.slides.limit_announcements_to_five
tier: production
vertical: church
title: "Limit Announcements To Five"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Limit Announcements To Five

## Purpose

Church presentation slide skill: limit announcements to five.
