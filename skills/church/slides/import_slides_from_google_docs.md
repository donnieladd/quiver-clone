---
id: church.slides.import_slides_from_google_docs
tier: production
vertical: church
title: "Import Slides From Google Docs"
inputs: [sermon_or_worship_content, series_theme]
outputs: [slide_deck]
related: [church.qa.projection_legibility, church.workflow.weekly_service_kit]
---

# Import Slides From Google Docs

## Purpose

Church presentation slide skill: import slides from google docs.
